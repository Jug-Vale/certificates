...
public class ConferenceData {
    ...
    public static ConferenceData of(List<Conference> conferences, List<Attendee> attendees,
            List<Registration> registrations) {
        return new ConferenceData(conferences, attendees, registrations);
    }

    public static ConferenceData empty() {
        return new ConferenceData(Collections.emptyList(), Collections.emptyList(), Collections.emptyList());
    }
    ...
    public String toString() {
        return "ConferenceData [conferences=" + conferences + ", attendees=" + attendees + ", registrations="
                + registrations + "]";
    }
}
